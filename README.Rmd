...
1. **The variables have labels**.  
    This allows information that is typically not encoded in the variable name, such as units or more detailed and human readable text, to be associated with each data column.
